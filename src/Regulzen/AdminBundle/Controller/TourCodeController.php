...
use Regulzen\CoreBundle\Entity\TourCode;
use Regulzen\AdminBundle\Form\TourCodeType;
...
class TourCodeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('RegulzenCoreBundle:TourCode')->findAll();
     ...
     * @Method("POST")
     * @Template("RegulzenCoreBundle:TourCode:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('RegulzenCoreBundle:TourCode')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("RegulzenCoreBundle:TourCode:edit.html.twig")
     */
