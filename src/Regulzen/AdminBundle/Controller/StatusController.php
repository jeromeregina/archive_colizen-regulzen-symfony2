...
use Regulzen\CoreBundle\Entity\Status;
use Regulzen\AdminBundle\Form\StatusType;
...
class StatusController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $query=$em->getRepository('RegulzenCoreBundle:Status')->findAllQuery();
     ...
     * @Method("POST")
     * @Template("RegulzenCoreBundle:Status:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('RegulzenCoreBundle:Status')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("RegulzenCoreBundle:Status:edit.html.twig")
     */
