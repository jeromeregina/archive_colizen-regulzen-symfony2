...
use Regulzen\AdminBundle\Form\CycleType;
...
class CycleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('RegulzenCoreBundle:Cycle')->findAll();
     ...
     * @Method("POST")
     * @Template("RegulzenCoreBundle:Cycle:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('RegulzenCoreBundle:Cycle')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("RegulzenCoreBundle:Cycle:edit.html.twig")
     */
