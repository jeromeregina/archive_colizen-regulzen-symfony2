...
use Regulzen\CoreBundle\Entity\ShipperAccount;
use Regulzen\AdminBundle\Form\ShipperAccountType;
...
class ShipperAccountController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('RegulzenCoreBundle:ShipperAccount')->findAll();
     ...
     * @Method("POST")
     * @Template("RegulzenCoreBundle:ShipperAccount:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('RegulzenCoreBundle:ShipperAccount')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("RegulzenCoreBundle:ShipperAccount:edit.html.twig")
     */
