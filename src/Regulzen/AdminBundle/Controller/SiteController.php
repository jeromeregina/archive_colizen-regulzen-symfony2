...
use Regulzen\AdminBundle\Form\SiteType;
...
class SiteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('RegulzenCoreBundle:Site')->findAll();
     ...
     * @Method("POST")
     * @Template("RegulzenCoreBundle:Site:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('RegulzenCoreBundle:Site')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("RegulzenCoreBundle:Site:edit.html.twig")
     */
