...
use Regulzen\CoreBundle\Entity\CustomerServiceRequest;
...
class AdminController extends Controller
{
    ...
    {
        /* @var $ws \Regulzen\CoreBundle\SoapClient\RegulzenWebService */
        $ws=$this->get('regulzen_core.soapclient.czn_webservice');
