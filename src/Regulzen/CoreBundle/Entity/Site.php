 ...
 * @ORM\Entity(repositoryClass="Regulzen\CoreBundle\Repository\Site")
 */
class Site
{
    /**
     ...
     * Set codeRegulzen
     *
     * @param string $codeRegulzen
     *
     * @return Site
     */
    public function setCodeRegulzen($codeRegulzen)
    {
        $this->codeRegulzen = $codeRegulzen;
     ...
     * @return string
     */
    public function getCodeRegulzen()
    {
        return $this->codeRegulzen;
    }
