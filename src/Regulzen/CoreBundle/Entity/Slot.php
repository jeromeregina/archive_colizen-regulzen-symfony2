 ...
 * @ORM\Entity(repositoryClass="Regulzen\CoreBundle\Repository\Slot")
 */
class Slot
{
   /**
    ...
    */
     ...
     * @return Slot
     */
    public function setShipment(\Regulzen\CoreBundle\Entity\Shipment $shipment)
    {
     ...
     * Set realTour
     *
     * @param  \Regulzen\CoreBundle\Entity\Tour $realTour
     * @return Slot
     */
     ...
     * Set theoricalTour
     *
     * @param  \Regulzen\CoreBundle\Entity\Tour $theoricalTour
     * @return Slot
     */
     ...
     * @return Slot
     */
    public function addEvent(\Regulzen\CoreBundle\Entity\Event $events)
    {
        $this->events[] = $events;
     ...
     * @param \Regulzen\CoreBundle\Entity\Event $events
     */
    public function removeEvent(\Regulzen\CoreBundle\Entity\Event $events)
    {
