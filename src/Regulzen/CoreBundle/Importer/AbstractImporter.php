...
use Regulzen\CoreBundle\Entity\Tour;
...
abstract class AbstractImporter
{
    ...
    /**
     *
     * @return \Regulzen\CoreBundle\Repository\Shipment
     */
    protected function getShipmentRepository()
    {
       return $this->em->getRepository('RegulzenCoreBundle:Shipment');
    }
    /**
     *
     * @return \Regulzen\CoreBundle\Repository\ShipperAccount
     */
    protected function getShipperAccountRepository()
    {
       return $this->em->getRepository('RegulzenCoreBundle:ShipperAccount');
    }
    /**
     *
     * @return \Regulzen\CoreBundle\Repository\Site
     */
    protected function getSiteRepository()
    {
       return $this->em->getRepository('RegulzenCoreBundle:Site');
    }
    /**
     *
     * @return \Regulzen\CoreBundle\Repository\Tour
     */
    protected function getTourRepository()
    {
       return $this->em->getRepository('RegulzenCoreBundle:Tour');
    }
    /**
     *
     * @return \Regulzen\UserBundle\Repository\User
     */
    protected function getUserRepository()
    {
       return $this->em->getRepository('RegulzenUserBundle:User');
    }
    /**
