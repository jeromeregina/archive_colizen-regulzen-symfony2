...
class UserChecker extends BaseChecker{
    ...
    public function checkPreAuth(UserInterface $user)
    {
        ...
        $existingSessions=$this->em->getRepository('NovactiveAdminBundle:Session')->findByUser($user);
