...
use Novactive\AdminBundle\Form\CycleType;
...
class CycleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('NovactiveAdminBundle:Cycle')->findAll();
     ...
     * @Method("POST")
     * @Template("NovactiveAdminBundle:Cycle:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('NovactiveAdminBundle:Cycle')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("NovactiveAdminBundle:Cycle:edit.html.twig")
     */
