...
use Novactive\AdminBundle\Form\SenderType;
...
class SenderController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('NovactiveAdminBundle:Sender')->findAll();
     ...
     * @Method("POST")
     * @Template("NovactiveAdminBundle:Sender:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('NovactiveAdminBundle:Sender')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("NovactiveAdminBundle:Sender:edit.html.twig")
     */
