...
use Novactive\AdminBundle\Form\SiteType;
...
class SiteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('NovactiveAdminBundle:Site')->findAll();
     ...
     * @Method("POST")
     * @Template("NovactiveAdminBundle:Site:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('NovactiveAdminBundle:Site')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("NovactiveAdminBundle:Site:edit.html.twig")
     */
