 ...
 * @ORM\Entity(repositoryClass="Colizen\AdminBundle\Repository\TourCode")
 */
class TourCode
{
    /**
     ...
     * Add tours
     *
     * @param \Colizen\AdminBundle\Entity\Tour $tours
     *
     * @return TourCode
     */
    public function addTour(\Colizen\AdminBundle\Entity\Tour $tours)
    {
        $this->tours[] = $tours;
     ...
     * @param \Colizen\AdminBundle\Entity\Tour $tours
     */
    public function removeTour(\Colizen\AdminBundle\Entity\Tour $tours)
    {
